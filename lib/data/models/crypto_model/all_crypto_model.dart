...
class Data {
  Data({
    List<CryptoDataModel>? cryptoCurrencyList,
    String? totalCount,
  }) {
  ...
  Data.fromJson(dynamic json) {
    if (json['cryptoCurrencyList'] != null) {
      ...
      json['cryptoCurrencyList'].forEach((v) {
        _cryptoCurrencyList?.add(CryptoDataModel.fromJson(v));
      });
    }
    _totalCount = json['totalCount'];
  }
  List<CryptoDataModel>? _cryptoCurrencyList;
  String? _totalCount;

  List<CryptoDataModel>? get cryptoCurrencyList => _cryptoCurrencyList;
  String? get totalCount => _totalCount;

  set cryptoCurrencyList(List<CryptoDataModel>? value) {
